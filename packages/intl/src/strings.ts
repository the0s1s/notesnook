...
$day$: Current day (eg. Monday)`,
  ...
  setAsTemplateSource: () => t`Set as template source`,
  templates: () => t`Templates`,
  newNoteFromTemplate: () => t`New note from template`,
  insertTemplate: () => t`Insert template`,
  noTemplateSourceSet: () =>
    t`No template source set. Set a notebook or tag as your template source to use templates.`,
  noTemplatesFound: () => t`No templates found.`,
